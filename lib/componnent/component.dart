...
import 'package:crm_app/screens/drawer_screens/customer_managment/component/controller/get_client.dart';
import 'package:crm_app/screens/drawer_screens/customer_managment/component/controller/get_followups_api.dart';
  ...
  Widget okButton = Container(
    ...
    child: Column(
      children: [
        ...
        Container(
          child: FutureBuilder(
            future: getFollowUps(context, clientID),
              ...
              if(snapshot.hasData){
                return ListView.separated(
                  ...
                  SizedBox(
                    ...
                    child: InkWell(
                      onTap: (){
                        AppCubit.get(context).changeChooseClient(newChoose: snapshot.data[index]['ClientDetails']['Name']);
                        Navigator.pop(context);
                      },
                      child: Row(
                        children: [
                          Text(snapshot.data[index]['ClientDetails']['cellphone'],style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 14,
                            fontFamily: 'Cairo',
                          ),),
                          Spacer(),
                          Text(snapshot.data[index]['ClientDetails']['Name'],style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 14,
                            fontFamily: 'Cairo',
                          ),),
