...
import 'componnent/component.dart';
import 'httpServices/endpoints.dart';
...
class ProjectUnitSearch extends SearchDelegate {
  ...
  // get index => null;
  // {{url}}/Units?project_id=None&city_id&governorate_id=الدقهلية&from_price&to_price&from_space&to_space


  Future serachdb(String name) async {
    try{
      var response  = await http.get(Uri.parse(EndPoints.BASE_URL+"/Units?project_id=None&city_id&governorate_id=$name&from_price&to_price&from_space&to_space"));
