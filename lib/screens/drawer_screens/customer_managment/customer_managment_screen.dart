...
import '../../../clients_search_class.dart';
                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          onTap: ()=> showSearch(context: context, delegate: ClientsSearch()),
                          child: Container(
                    ...
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          dismiss.add(buildCustomerManagementCard(
                            ...
                            referral: _posts[index]['referral'].toString(), // referral
                            whatsPhone: _posts[index]['whatsapp'],
                            // clientJobTitle: _posts[index]['referral'].toString(),
                          ...
                          return  Dismissible(
                            ...
                            child: buildCustomerManagementCard(
                              referral: _posts[index]['referral'],
                              clientState: _posts[index]['status'],
                              id: "${_posts[index]['id']}",
                              context: context,
                              email: _posts[index]['email'],
                              cellPhone: _posts[index]['cellphone'],
